...
| 2						 | **START**. Fuel and ignition are turned on  | RPM exceeds X2 or time with starter on exceeds timeout value | 3 (or 9 if timed out) |
...
| 9            | **KILLED**. Engine has been killed due to kill switching being pressed <br /> Engine will also go into this state if it remains in **START** phase for too long | Engine RPM returns to 0 | 0 |
